 ...
 * @author RojeruSan
 */
public class CargandoRespaldo extends javax.swing.JDialog {

    /**
     * Creates new form Cargando
     */
    public CargandoRespaldo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        msj.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargandoRespaldo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CargandoRespaldo dialog = new CargandoRespaldo(new javax.swing.JFrame(), true);
